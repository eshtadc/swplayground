...
const CERT_KEY_PATH = path.join(PRIVATE_FOLDER_PATH, 'server.key');
const CERT_PATH = path.join(PRIVATE_FOLDER_PATH, 'server.crt');
...
getDevelopmentCertificate('swplayground', { installCertutil: true })
  .then(({key, cert}) => {
